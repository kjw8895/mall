...
public class ProductController {
    ...
    @PostMapping()
    public ResponseEntity<CommonResponse<ProductDto>> save(@CurrentUser UserInfo userInfo, @RequestPart("request") ProductCreateDto dto, @RequestPart(required = false, value = "image") MultipartFile image, @RequestPart(required = false, value = "video") MultipartFile video) {
